...
const AnalyticsTab = () => {
 ...
 if (isLoading) {
    return (
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col items-center justify-center h-64'>
        <Loader2 className="animate-spin text-emerald-500 text-6xl mb-4" />
		...
		<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
			<div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8'>
				...
				<AnalyticsCard
					...
					value={analyticsData.product.toLocaleString()}
					icon={Package}
